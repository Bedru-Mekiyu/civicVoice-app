    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/20 to-primary/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {services.map((service) => {
            ...
            return (
              <Link key={service.id} to={`/feedback?service=${service.id}`}>
                <Card className="h-full hover:shadow-lg transition-shadow duration-200 cursor-pointer group bg-card">
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      <p className="text-sm font-medium text-foreground">
                        {t("services.related_institutions")}
                      </p>
        ...
        <div className="mt-16 text-center">
          <div className="bg-card/80 backdrop-blur-md rounded-2xl shadow-lg border border-border p-8 max-w-2xl mx-auto">
            <h2 className="text-2xl font-bold text-foreground mb-4">
              {t("services.cant_find_title")}
            </h2>
            <p className="text-muted-foreground mb-6">
              {t("services.cant_find_description")}
            </p>
            <Link to="/feedback">
              <Button className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-3 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-lg">
